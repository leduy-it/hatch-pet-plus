...
> Nimbus — a glossy vinyl toy cloud-creature, 3D TOY style. A plump rounded cumulus body in soft off-white with a pale blue underside. Two large glossy black eyes with bright highlights and rosy cheeks. Four tiny stubby legs. A small curl of cloud sweeps up like a quiff on its head. Smooth moulded plastic with soft specular highlights.

<p align="center">
  <img src="hero.gif" width="240" alt="Nimbus idling">
</p>
...
| <img src="previews/jumping.gif" width="76"> | `jumping` | **you hover it** <br><sub>a small joyful hop — the most-seen animation</sub> | 5 | 159px |
...
```
nimbus PASS key=#00FF00 lean=0.0% ring=14% spread=2%
```
