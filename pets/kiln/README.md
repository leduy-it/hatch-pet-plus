...
> Kiln — a chubby pot-bellied creature sculpted from warm terracotta clay, CLAYMATION style, shaped like a rounded ceramic jar with stubby arms and legs. A spiral is pressed into its belly. Two small dark clay eyes and a simple pressed-in smile. A tiny clay lid tilted on its head like a hat. Visible thumbprints and sculpting marks, matte earthenware surface.

<p align="center">
  <img src="hero.gif" width="240" alt="Kiln idling">
</p>
...
| <img src="previews/failed.gif" width="76"> | `failed` | Codex failed or was cancelled <br><sub>deflated, disappointed</sub> | 8 | 159px |
...
```
kiln PASS key=#00FFFF lean=0.0% ring=14% spread=1%
```
