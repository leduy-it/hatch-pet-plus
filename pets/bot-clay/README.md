...
> Sprocket — a small friendly desk-companion ROBOT sculpted from modelling clay, CLAYMATION style. Compact rounded barrel chassis on two stubby legs. One large round amber visor-eye. Two small arms with round grabber hands. A bent antenna with a bead. A round dial pressed into its chest. Slate-blue clay body with cream clay panels. Visible thumbprints and tool marks, matte earthenware surface.

<p align="center">
  <img src="hero.gif" width="240" alt="Sprocket Clay idling">
</p>
...
```
bot-clay PASS key=#FF00FF lean=0.0% ring=9% spread=2%
```
