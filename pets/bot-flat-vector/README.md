...
> Sprocket — a small friendly desk-companion ROBOT in FLAT VECTOR style. Compact rounded barrel chassis on two stubby legs. One large round amber visor-eye with a crisp highlight. Two small arms with round grabber hands. A bent antenna with a bead. A round dial on its chest. Slate-blue body with cream panels. Bold clean geometric shapes, flat colour fills, NO gradients, NO texture, crisp edges, confident outline.

<p align="center">
  <img src="hero.gif" width="240" alt="Sprocket Vector idling">
</p>
...
| <img src="previews/jumping.gif" width="76"> | `jumping` | **you hover it** <br><sub>a small joyful hop — the most-seen animation</sub> | 5 | 153px |
...
```
bot-flat-vector PASS key=#FF00FF lean=0.0% ring=10% spread=6%
```
...
```bash
./install.sh --pet bot-flat-vector
```
