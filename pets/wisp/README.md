...
> Wisp — a small brass lantern spirit: a glass lantern body holding a blue flame core, two round eyes on the glass, and a purple cloth hood with pointed cat-like ears drawn over the top.

<p align="center">
  <img src="hero.gif" width="240" alt="Wisp idling">
</p>
...
```
wisp PASS key=#00FF00 lean=0.0% ring=10% spread=1%
```
