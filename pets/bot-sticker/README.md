...
> Sprocket — a small friendly desk-companion ROBOT as a die-cut vinyl STICKER. Compact rounded barrel chassis on two stubby legs. One large round amber visor-eye. Two small arms with round grabber hands. A bent antenna with a bead. A round dial on its chest. Slate-blue body with cream panels. Bold thick WHITE STICKER BORDER around the whole silhouette, saturated colours, clean cel shading, crisp graphic edges.

<p align="center">
  <img src="hero.gif" width="240" alt="Sprocket Sticker idling">
</p>
...
```
bot-sticker PASS key=#FF00FF lean=0.0% ring=0% spread=0%
```
