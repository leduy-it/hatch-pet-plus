...
> An adorable PIXEL ART blue bunny. IDENTITY: soft periwinkle/cornflower BLUE fur; WHITE/CREAM muzzle, cheek ruff, chest and belly; TALL upright ears with soft PINK inner ears; BIG round AMBER-BROWN eyes with dark pupils and a white sparkle highlight; small PINK nose; two tiny white BUCK TEETH; cheerful smile; pink blush cheeks; chibi proportions with a big round head, smaller rounded body, tiny stubby limbs and a small fluffy tail. NO props, NO accessories.

<p align="center">
  <img src="hero.gif" width="240" alt="Bunny idling">
</p>
...
| <img src="previews/running.gif" width="76"> | `running` | Codex is working / thinking <br><sub>focused effort — *not* foot-running</sub> | 6 | 161px |
| <img src="previews/review.gif" width="76"> | `review` | Codex is reviewing output <br><sub>leaning in, inspecting</sub> | 6 | 161px |
...
```
bunny PASS key=#00FF00 lean=0.0% ring=9% spread=1%
```
