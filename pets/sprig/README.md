...
> Sprig — a mossy green seedling creature with a curled fiddlehead frond rising from its crown, overlapping leaf collar around its body, round cheeks, and small stubby feet.

<p align="center">
  <img src="hero.gif" width="240" alt="Sprig idling">
</p>
...
| <img src="previews/failed.gif" width="76"> | `failed` | Codex failed or was cancelled <br><sub>deflated, disappointed</sub> | 8 | 160px |
| <img src="previews/waiting.gif" width="76"> | `waiting` | Codex is blocked on you <br><sub>an expectant, asking pose</sub> | 6 | 160px |
...
```
sprig PASS key=#00FFFF lean=0.0% ring=0% spread=1%
```
