...
> Sprocket — a small friendly desk-companion ROBOT, TRUE CHUNKY PIXEL ART. A compact rounded barrel chassis on two short stubby legs with round feet. One large round glass VISOR-EYE glowing warm amber with a bright highlight. Two small jointed arms with round grabber hands. A short bent antenna with a bead on top. A round dial set into its chest. Warm slate-blue body with cream panel accents and tiny amber indicator lights. Coarse uniform square pixel blocks, limited flat palette, clean 1-pixel dark outline.

<p align="center">
  <img src="hero.gif" width="240" alt="Sprocket Pixel idling">
</p>
...
| <img src="previews/running-right.gif" width="76"> | `running-right` | **you drag it right** <br><sub>travels right with a walking cadence</sub> | 8 | 157px |
| <img src="previews/running-left.gif" width="76"> | `running-left` | **you drag it left** <br><sub>the mirror of running-right</sub> | 8 | 157px |
| <img src="previews/waving.gif" width="76"> | `waving` | greeting <br><sub>a friendly wave</sub> | 4 | 161px |
| <img src="previews/jumping.gif" width="76"> | `jumping` | **you hover it** <br><sub>a small joyful hop — the most-seen animation</sub> | 5 | 161px |
| <img src="previews/failed.gif" width="76"> | `failed` | Codex failed or was cancelled <br><sub>deflated, disappointed</sub> | 8 | 142px |
| <img src="previews/waiting.gif" width="76"> | `waiting` | Codex is blocked on you <br><sub>an expectant, asking pose</sub> | 6 | 161px |
| <img src="previews/running.gif" width="76"> | `running` | Codex is working / thinking <br><sub>focused effort — *not* foot-running</sub> | 6 | 157px |
...
```
bot-pixel PASS key=#FF00FF lean=0.0% ring=15% spread=12%
```
