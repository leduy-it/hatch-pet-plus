...
> Dewel — a pale mint-blue amphibian with a translucent water-droplet shell over its head like a cap, wide friendly eyes, small fin-like side frills, and a smooth rounded body.

<p align="center">
  <img src="hero.gif" width="240" alt="Dewel idling">
</p>
...
```
dewel PASS key=#FF00FF lean=0.0% ring=0% spread=1%
```
