...
> Mossback — a small round cozy creature like a living cushion of forest floor, PLUSH/FELT style. Its body is a soft dome of deep-green moss with a stitched felt underside in warm oatmeal. Two tiny amber eyes peek out from under the mossy fringe. Three small coral-pink mushroom caps grow on its back. Four stubby felt feet. Visible fabric weave and stitched seams, matte fibre texture.

<p align="center">
  <img src="hero.gif" width="240" alt="Mossback idling">
</p>
...
| <img src="previews/waiting.gif" width="76"> | `waiting` | Codex is blocked on you <br><sub>an expectant, asking pose</sub> | 6 | 158px |
...
| <img src="previews/review.gif" width="76"> | `review` | Codex is reviewing output <br><sub>leaning in, inspecting</sub> | 6 | 158px |

Rows 9 and 10 are the **16 look directions**: as you move your cursor, the pet's head turns to follow it, in 22.5° steps.

The pet is drawn the **same size in every lane** (spread 2%), so it does not visibly resize when you hover or drag it.
...
```
mossback PASS key=#00FFFF lean=0.0% ring=19% spread=2%
```
