...
> Sprocket — a small friendly desk-companion ROBOT as a glossy 3D VINYL TOY. Compact rounded barrel chassis on two stubby legs. One large round glossy amber visor-eye. Two small arms with round grabber hands. A bent antenna with a bead. A round dial on its chest. Slate-blue moulded plastic with cream panels. Smooth glossy surfaces, soft specular highlights, collectible-figure look.

<p align="center">
  <img src="hero.gif" width="240" alt="Sprocket Toy idling">
</p>
...
```
bot-3d-toy PASS key=#FF00FF lean=0.0% ring=2% spread=0%
```
